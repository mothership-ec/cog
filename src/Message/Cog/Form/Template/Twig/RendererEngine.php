 ...
 * Taken from Symfony
 *
 * @see https://github.com/symfony/TwigBridge/blob/master/Form/TwigRendererEngine.php
 *
 * @author Thomas Marchant <thomas@message.co.uk>
 */
class RendererEngine extends AbstractRendererEngine implements RendererEngineInterface
{
    /**
